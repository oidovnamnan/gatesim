...
export default function ContentManagerPage() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (!data.generated) {
                console.log('Using static poster:', data.message);
            }
        } catch (error: any) {
            console.error('Poster generation error:', error);
            // Fallback to static poster on error
            const staticPoster: GeneratedPoster = {
                imageUrl: `/posters/${selectedTheme}.png`,
                captionMN: "🌅 Өглөөний мэнд!\n\n✈️ Аялалаа төлөвлөж байна уу?\n📱 GateSIM-ээр 200+ улсад интернет!\n\n👉 gatesim.travel",
                captionEN: "🌅 Good morning!\n\n✈️ Planning your next trip?\n📱 Stay connected with GateSIM!\n\n👉 gatesim.travel",
                hashtags: "#GateSIM #eSIM #Travel"
            };
            setPoster(staticPoster);
        } finally {
            setGenerating(false);
        }
    };
